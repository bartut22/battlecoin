  ...
  return <main className="exchange">
    ...
    <div className="workspace">
      <div className="main-column">
        ...
        <footer className="deck-bar"><div className="capital"><div className="capital-title"><small>Elixir capital</small><b>{usd(state.capital)}</b></div><div className="elixir-bar" role="meter" aria-label="Available trading capital" aria-valuemin="0" aria-valuemax={state.fundedCapital||100} aria-valuenow={state.capital}><i style={{width:`${capitalPercent}%`}}/></div><div className="capital-actions"><span>{usd(state.fundedCapital||100)} funded</span><button onClick={()=>battle.current?.depositCapital(100)}><Plus size={13}/>Deposit</button></div></div>
